...
<head>
    ...
    <title>PASWA TAHUN 2022 - Register</title>
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">REGISTRASI PASWA 2022</h1>
                            </div>
                            <form method="post" action="simpan_pendaftaran.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <label>Foto</label>
                                        <input type="file" class="form-control form-control-user" id="exampleLastName" placeholder="Foto" name="foto">
                                    </div>
                                </div>
